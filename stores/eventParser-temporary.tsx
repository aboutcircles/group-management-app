import { CirclesEvent, CirclesEventType } from '@circles-sdk/data';
  ...
  switch (event) {
    ...
    case 'CrcV2_PersonalMint':
      return {
        ...
        startPeriod: values.startPeriod
          ? hexToBigInt(values.startPeriod)
          : undefined,
    ...
    case 'CrcV2_UpdateMetadataDigest':
      return {
        ...
        avatar: values.avatar,
        metadataDigest: values.metadataDigest
          ? hexToUint8Array(values.metadataDigest)
          : undefined,
      };
    case 'CrcV2_CidV0':
      return {
        ...
        $event: 'CrcV2_CidV0',
        avatar: values.avatar,
        cidV0Digest: values.cidV0Digest
    ...
    case 'CrcV2_GroupMintBatch':
      return {
        ...
        userData: values.userData
          ? hexToUint8Array(values.userData)
          : undefined,
      };
    ...
    case 'CrcV2_DepositDemurraged':
      return {
        ...
        account: values.account,
        amount: values.amount ? hexToBigInt(values.amount) : undefined,
        inflationaryAmount: values.inflationaryAmount
          ? hexToBigInt(values.inflationaryAmount)
          : undefined,
      };
    case 'CrcV2_DepositInflationary':
      return {
        ...
        account: values.account,
        amount: values.amount ? hexToBigInt(values.amount) : undefined,
        demurragedAmount: values.demurragedAmount
          ? hexToBigInt(values.demurragedAmount)
          : undefined,
      };
...
export const parseRpcSubscriptionMessage = (
  message: RpcSubscriptionMessage
): CirclesEvent[] => {
  return message
    .map((result) => parseEventValues(result.event, result.values))
